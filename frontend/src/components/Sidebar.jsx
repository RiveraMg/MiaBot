            ...
            <div className="flex items-center justify-between h-16 px-4 border-b border-dark-800">
                <div className="flex items-center gap-3">
                    <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center">
                        <img src="/logo.png" alt="MiaBot" className="w-17 h-17 object-contain" />
                    </div>
            ...
            <nav className="flex-1 p-3 space-y-1 overflow-y-auto scrollbar-thin">
                ...
                {isFinance() && (
                    <>
                        ...
                        <NavItem to="/app/products" icon={Package} label="Inventario" />
                        <NavItem to="/app/clients" icon={Users} label="Clientes" />
                        <NavItem to="/app/suppliers" icon={Truck} label="Proveedores" />
                ...
                {isHR() && (
                    <>
                        ...
                        <NavItem to="/app/employees" icon={Users} label="Empleados" />
                        <NavItem to="/app/events" icon={Calendar} label="Eventos" />
                        <NavItem to="/app/leave-requests" icon={CalendarOff} label="Permisos" />
                    </>
                )}
                ...
                <NavItem to="/app/chat" icon={MessageSquare} label="Chat IA" />

                {isAdmin() && (
                    <NavItem to="/app/settings" icon={Settings} label="Configuración" />
                )}
            </nav>
