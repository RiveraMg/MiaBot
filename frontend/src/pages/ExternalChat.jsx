...
const ExternalChat = () => {
    ...
    const [messages, setMessages] = useState([
        {
            role: 'assistant',
            content:
                '¡Hola! 👋 Soy MiaBot, tu asistente virtual.\n\nPuedes escribirme cualquier duda sobre productos, servicios, cotizaciones o soporte.\n\n¿En qué puedo ayudarte hoy?'
        }
    ]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await chatAPI.sendExternal(
                userMessage,
                { companyId },
                sessionId
            );
                ...
                <div className="h-[calc(100vh-3rem)] flex flex-col">
                    ...
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-xl font-bold text-dark-50">Chat con MiaBot</h1>
                    ...
                    {!companyId && (
                        <div className="alert-danger mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm">
                                    Debes definir <span className="font-mono">VITE_COMPANY_ID</span> en el
                                    frontend para usar el chat externo.
                                </p>
                            </div>
                        </div>
                    )}
                            ...
                            {loading && (
                                <div className="flex gap-3">
                                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center">
                                        <img src="/logo.png" alt="MiaBot" className="w-5 h-5 object-contain" />
                                    </div>
